...
\def\addemptypagespredoc {true}   % Añade pag. en blanco después de portada,etc.
\def\defaultinterline {1.25}       % Interlineado por defecto [pt]
...
\def\nomltfigure {Índice de Ilustraciones} % Nombre del índice de lista de figuras
