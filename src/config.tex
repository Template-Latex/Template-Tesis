...
\def\stylecitereferences {natbib}  % Estilo cita/ref {apacite,bibtex,natbib,custom}
...
\def\footnotepagetoprule {true}    % Footnote en pag. tienen separador superior
...
\def\tablepaddingh {0.5}           % Espaciado horizontal de celda de las tablas
\def\tablepaddingv {1.1}           % Espaciado vertical de celda de las tablas
...
\def\nomltcont {Tabla de Contenido}   % Nombre del índice de contenidos
