...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={2.1.2-1-THS},
		Template.Version.Hash={2B5EA165711C03CEE2E10E44D0A4F5B5},
	...
	pdfproducer={Template-Tesis v2.1.2 | (Pablo Pizarro R.) ppizarror.com},
