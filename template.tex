...
\usepackage{atbegshi}      % Permite añadir hooks al inicio de las páginas
...
\newcommand{\coreinsertemptypagepredoc}[1]{
	\ifthenelse{\equal{\addemptypagespredoc}{true}}{

% Inserta una página vacía si el número es impar y está activada la opción
%	#1	Tipo de página (odd/even)
\newcommand{\coreinsertemptypageif}[1]{
	\ifthenelse{\equal{\addemptypagespredoc}{true}}{
		\leavevmode\checkoddpage
		\ifoddpage
			par
			\ifthenelse{\equal{#1}{odd}}{\insertemptypage}{}
		\else
			impar
			\ifthenelse{\equal{#1}{even}}{\insertemptypage}{}
		\fi}{
	}
}
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={2.5.5-THS},
		Template.Version.Hash={8F894B3FA118430B7ED0BD878A5AA5B7},
		Template.Version.Release={2.5.5},
	...
	pdfproducer={Template-Tesis v2.5.5 | (Pablo Pizarro R.) ppizarror.com},
