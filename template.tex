...
\newenvironment{resumen}{
	\clearpage
	\chapter*{\nameresumen}
	\ifthenelse{\equal{\addresumentobookmarks}{true}}{
		\phantomsection
		\pdfbookmark{\nameresumen}{abstract}}{
	}
	\forceindent
...
\hypersetup{
	...
	pdfinfo={
		...
		Template.Version.Dev={2.2.7-2-THS},
		Template.Version.Hash={FF7312F613039C4CD83EF3D59F4FB0BA},
		Template.Version.Release={2.2.7},
	...
	pdfproducer={Template-Tesis v2.2.7 | (Pablo Pizarro R.) ppizarror.com},
